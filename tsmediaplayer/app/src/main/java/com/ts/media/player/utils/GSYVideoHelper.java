package com.ts.media.player.utils;
...
import com.ts.media.player.listener.GSYVideoProgressListener;
import com.ts.media.player.listener.LockClickListener;
import com.ts.media.player.listener.VideoAllCallBack;
import com.ts.media.player.render.view.GSYVideoGLView;
import com.ts.media.player.video.StandardGSYVideoPlayer;
import com.ts.media.player.video.base.GSYBaseVideoPlayer;
...
public class GSYVideoHelper {
    ...
    public GSYVideoHelper(Context context, StandardGSYVideoPlayer player) {
        ...
        this.mWindowViewContainer = (ViewGroup) (com.ts.media.player.utils.CommonUtil.scanForActivity(context)).findViewById(Window.ID_ANDROID_CONTENT);
    ...
    private void resolveToFull() {
        ...
        com.ts.media.player.utils.CommonUtil.hideSupportActionBar(mContext, mVideoOptionBuilder.isHideActionBar(), mVideoOptionBuilder.isHideStatusBar());
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (mVideoOptionBuilder.getVideoAllCallBack() != null) {
                    com.ts.media.player.utils.Debuger.printfLog("onQuitFullscreen");
