...
import com.ts.media.player.GSYVideoBaseManager;
...
public class GSYVideoManager extends GSYVideoBaseManager {
    ...
    public static final int SMALL_ID = com.ts.media.player.R.id.small_id;

    public static final int FULLSCREEN_ID = com.ts.media.player.R.id.full_id;
