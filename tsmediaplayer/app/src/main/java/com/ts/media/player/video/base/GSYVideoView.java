...
import com.ts.media.player.utils.NetInfoModule;
import com.ts.media.player.video.base.GSYTextureRenderView;
import com.ts.media.player.video.base.GSYVideoViewBridge;

import java.io.File;
import java.util.HashMap;
import java.util.Map;
import static com.ts.media.player.utils.CommonUtil.getTextSpeed;
