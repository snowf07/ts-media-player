package com.ts.media.player.enviews;
...
public class ENPlayView extends AppCompatImageView {
...
//            setBackgroundResource(R.drawable.ul);
    ...
    public void play() {
        ...
        setBackgroundDrawable(getResources().getDrawable(R.drawable.uk));
    ...
    public void pause() {
        ...
        setBackgroundDrawable(getResources().getDrawable(R.drawable.ul));
