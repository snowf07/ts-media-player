package com.ts.media.player.video.base;
...
import com.ts.media.player.utils.CommonUtil;
import com.ts.media.player.utils.Debuger;
import com.ts.media.player.utils.OrientationUtils;
import com.ts.media.player.video.base.GSYVideoControlView;
import com.ts.media.player.video.base.GSYVideoPlayer;
import com.ts.media.player.view.SmallVideoTouch;

import java.lang.reflect.Constructor;

import static com.ts.media.player.utils.CommonUtil.getActionBarHeight;
import static com.ts.media.player.utils.CommonUtil.getStatusBarHeight;
import static com.ts.media.player.utils.CommonUtil.hideNavKey;
import static com.ts.media.player.utils.CommonUtil.hideSupportActionBar;
import static com.ts.media.player.utils.CommonUtil.showNavKey;
import static com.ts.media.player.utils.CommonUtil.showSupportActionBar;
...
public abstract class GSYBaseVideoPlayer extends GSYVideoControlView {
    ...
    private void pauseFullCoverLogic() {
        if (mCurrentState == com.ts.media.player.video.base.GSYVideoPlayer.CURRENT_STATE_PAUSE && mTextureView != null
    ...
    private void pauseFullBackCoverLogic(GSYBaseVideoPlayer gsyVideoPlayer) {
        //如果是暂停状态
        if (gsyVideoPlayer.mCurrentState == com.ts.media.player.video.base.GSYVideoPlayer.CURRENT_STATE_PAUSE
     ...
     * 恢复
     */
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, com.ts.media.player.video.base.GSYVideoPlayer gsyVideoPlayer) {
    ...
    protected void clearFullscreenLayout() {
        ...
        if (oldF != null) {
            ...
            com.ts.media.player.video.base.GSYVideoPlayer gsyVideoPlayer = (com.ts.media.player.video.base.GSYVideoPlayer) oldF;
    ...
    protected void backToNormal() {
        ...
        final View oldF = vp.findViewById(getFullId());
        final com.ts.media.player.video.base.GSYVideoPlayer gsyVideoPlayer;
        if (oldF != null) {
            gsyVideoPlayer = (com.ts.media.player.video.base.GSYVideoPlayer) oldF;
            //如果暂停了
    ...
    protected Runnable mCheckoutTask = new Runnable() {
        @Override
        public void run() {
            com.ts.media.player.video.base.GSYVideoPlayer gsyVideoPlayer = getFullWindowPlayer();
            if (gsyVideoPlayer != null
    ...
    public void hideSmallVideo() {
        final ViewGroup vp = getViewGroup();
        com.ts.media.player.video.base.GSYVideoPlayer gsyVideoPlayer = (com.ts.media.player.video.base.GSYVideoPlayer) vp.findViewById(getSmallId());
        removeVideo(vp, getSmallId());
        mCurrentState = getGSYVideoManager().getLastState();
        if (gsyVideoPlayer != null) {
            cloneParams(gsyVideoPlayer, this);
     ...
     */
    @SuppressWarnings("ResourceType")
    public com.ts.media.player.video.base.GSYVideoPlayer getFullWindowPlayer() {
        ...
        com.ts.media.player.video.base.GSYVideoPlayer gsyVideoPlayer = null;
        if (full != null) {
            gsyVideoPlayer = (com.ts.media.player.video.base.GSYVideoPlayer) full;
        }
        return gsyVideoPlayer;
    }
     ...
     */
    @SuppressWarnings("ResourceType")
    public com.ts.media.player.video.base.GSYVideoPlayer getSmallWindowPlayer() {
        ViewGroup vp = (ViewGroup) (CommonUtil.scanForActivity(getContext())).findViewById(Window.ID_ANDROID_CONTENT);
