...
public class SimpleActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VideoPlayerHelper.getInstance().play(getApplicationContext(), url, false, "", detailPlayer, new GSYSampleCallBack() {
            @Override
        ...
        detailPlayer.getFullscreenButton().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                detailPlayer.startWindowFullscreen(SimpleActivity1.this, true, true);
            }
        });
