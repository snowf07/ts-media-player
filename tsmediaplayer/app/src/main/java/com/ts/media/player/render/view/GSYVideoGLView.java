...
import com.ts.media.player.render.GSYRenderView;
import com.ts.media.player.render.view.IGSYRenderView;
import com.ts.media.player.render.view.listener.GSYVideoGLRenderErrorListener;
...
import com.ts.media.player.render.glrender.GSYVideoGLViewSimpleRender;
import com.ts.media.player.render.view.listener.GLSurfaceListener;
import com.ts.media.player.render.view.listener.IGSYSurfaceListener;
import com.ts.media.player.utils.Debuger;
import com.ts.media.player.utils.FileUtils;
import com.ts.media.player.utils.MeasureHelper;
import com.ts.media.player.render.effect.NoEffect;
